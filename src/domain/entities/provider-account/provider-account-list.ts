...
// The active provider connections of one account. Selecting which one provisions a given environment is a
// domain rule (an account may hold several providers), so it lives here rather than in the use case: the
