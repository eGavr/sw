...
// One (account, role, member) grant of an IAM policy. A member holding several roles, or a role held
...
@Entity()
export class AccountIamBinding {
    static make(accountId: string, role: string, member: string, createdAt: Date, updatedAt: Date): AccountIamBinding {
        const binding = new AccountIamBinding();
