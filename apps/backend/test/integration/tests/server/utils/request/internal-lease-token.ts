...
// Crafts a valid per-host token (HS256), matching Hs256LeaseTokenService, so integration tests can call
...
export function internalLeaseToken(leaseId: string, secret = "test-internal-secret"): string {
