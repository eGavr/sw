...
import { Hs256LeaseTokenService } from "./hs256-lease-token-service";
...
export const LeaseTokenServiceProvider = {
    provide: LeaseTokenService,
    useFactory: (configService: ConfigService): LeaseTokenService => {
        ...
        return new Hs256LeaseTokenService(key, ttl);
    },
