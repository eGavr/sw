...
export class ReturnableLeaseCriteria {
    static create(): ReturnableLeaseCriteria {
        return new ReturnableLeaseCriteria({
            states: [MachineLeaseState.Deleting, MachineLeaseState.Failed],
            mustBeEmpty: true,
        });
    }
